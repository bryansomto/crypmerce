      ...
      <Navbar variant="dark" expand="lg" bg="dark" className="navbar-transparent navbar-theme-primary sticky-top">
        <Container className="position-relative justify-content-between px-3">
          <Navbar.Brand as={HashLink} to="#home" className="me-lg-3 d-flex align-items-center">
            <Image src={ReactHero} />
            <span className="ms-2 brand-text d-none d-md-inline">Crypmerce</span>
          </Navbar.Brand>
          {/* <Navbar.Toggle as={Button} aria-controls="main-navbar" id="Toggler">
            <span className="navbar-toggler-icon" />
          </Navbar.Toggle> */}
          <Navbar.Collapse id="" className="position-relative mt-2 mt-md-0">
            <Nav className="me-auto">
              <Nav.Link as={HashLink} to="#features">Sign In</Nav.Link>
              <Nav.Link as={HashLink} to="#pages">Create Account</Nav.Link>
              <Nav.Link as={HashLink} to="#folder" className="d-sm-none d-xl-inline">Getting Started</Nav.Link>
              <Nav.Link as={HashLink} to="#getting-started">About</Nav.Link>
            </Nav>
          </Navbar.Collapse>
        </Container>
      </Navbar>
      <section className="section-header overflow-hidden pt-5 pt-lg-6 bg-primary text-white" id="home">
        <Container>
          <Row>
            <Col xs={12} className="text-center">
              <div className="react-big-icon d-none d-lg-block"><span className="fab fa-react"></span></div>
              <h1 className="fw-bolder text-secondary">Crypmerce</h1>
              <p className="text-muted fw-light mb-5 h5">Open source powered by React.js and Bootstrap 5</p>
              <div className="d-flex align-items-center justify-content-center row">
                <Button variant="secondary" as={Link} to={Routes.Signin.path} className="text-dark me-3 col-6 mb-2 mb-md-0 col-md-3">
                  Sign In <FontAwesomeIcon icon={faExternalLinkAlt} className="d-none d-sm-inline ms-1" />
                </Button>
                <Button variant="secondary" as={Link} to={Routes.Signup.path} className="text-dark me-3 col-6 mb-2 mb-md-0 col-md-3">
                  Create Account <FontAwesomeIcon icon={faExternalLinkAlt} className="d-none d-sm-inline ms-1" />
                </Button>
              ...
              <div className="d-flex justify-content-center flex-column mb-lg-3">
                <div className="text-center">
                  ...
                  <figure className="position-absolute bottom-0 left-0 w-100 d-block d-md-none mb-n2">
                    <svg className="fill-soft" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 3000 220">
                      <path d="M3000,0v185.4H0V0c496.4,115.6,996.4,173.4,1500,173.4S2503.6,115.6,3000,0z" />
                    </svg>
                  </figure>
                </div>
